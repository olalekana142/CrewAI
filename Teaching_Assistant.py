...
#os.environ['OPENAI_API_KEY'] ='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'


#os.environ["HUGGINGFACEHUB_API_TOKEN"] = "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"
...
researcher = Agent(
    ...
    backstory ="You are AI assistant to research and provide specific topic  or relevant information for teaching someone",
    verbose= True,
